...
namespace General.Classes
{
    class clsCommon : Connection
    {
        ...
        private void CreateTables()
        {
            ...
            CreateTable("BOUR", "Based Requiremwnt", SAPbobsCOM.BoUTBTableType.bott_Document);
            CreateTable("BOUR1", "Based Requirement row", SAPbobsCOM.BoUTBTableType.bott_DocumentLines);
            CreateTable("DCBA", "Based Document", SAPbobsCOM.BoUTBTableType.bott_Document);
            CreateTable("DCBA1", "Based Document row", SAPbobsCOM.BoUTBTableType.bott_DocumentLines);
            /*
                        #region No Object
        ...
        public void CreateFields()
        {
            ...
            FieldDetails(TableType.CustomTable, "DCBA", "DocNum", "DocNum", UDFFieldType.Alpha, false, 30, "", "", "");
            FieldDetails(TableType.CustomTable, "DCBA", "SDocDate", "SDocDate", UDFFieldType.Date, false, 15, "", "", "");
            FieldDetails(TableType.CustomTable, "DCBA", "code", "BPCode", UDFFieldType.Alpha, false, 40, "", "", "");
            FieldDetails(TableType.CustomTable, "DCBA", "name", "BPName", UDFFieldType.Alpha, false, 100, "", "", "");
            FieldDetails(TableType.CustomTable, "DCBA1", "ite", "item code", UDFFieldType.Alpha, false, 40, "", "", "");
            FieldDetails(TableType.CustomTable, "DCBA1", "dsc", "description", UDFFieldType.Alpha, false, 140, "", "", "");
            FieldDetails(TableType.CustomTable, "DCBA1", "qc", "quantity", UDFFieldType.Alpha, false, 50, "", "", "");
            FieldDetails(TableType.CustomTable, "DCBA1", "pr", "unit Price", UDFFieldType.Alpha, false, 50, "", "", "");
            FieldDetails(TableType.CustomTable, "DCBA1", "wrs", "warehouse code", UDFFieldType.Alpha, false, 20, "", "", "");
            ...
            FieldDetails(TableType.CustomTable, "BOUR", "DocNum", "DocNum", UDFFieldType.Alpha, false, 30, "", "", "");
            FieldDetails(TableType.CustomTable, "BOUR", "code", "cardCode", UDFFieldType.Alpha, false, 30, "", "", "");
            FieldDetails(TableType.CustomTable, "BOUR", "SDocDate", "SDocDate", UDFFieldType.Date, false, 15, "", "", "");
            FieldDetails(TableType.CustomTable, "BOUR", "Dct", "Document Type", UDFFieldType.Alpha, false, 105, "", "", "");
            FieldDetails(TableType.CustomTable, "BOUR", "st", "status Type", UDFFieldType.Alpha, false, 105, "", "", "");
            FieldDetails(TableType.CustomTable, "BOUR", "cl", "check Type", UDFFieldType.Alpha, false, 105, "", "", "");
            ...
            FieldDetails(TableType.CustomTable, "CCBI", "Rem", "Remarks", UDFFieldType.Alpha, false, 100, "", "", "");
            FieldDetails(TableType.CustomTable, "CCBI", "Pri", "Price list", UDFFieldType.Alpha, false, 100, "", "", "");
            FieldDetails(TableType.CustomTable, "CCBI", "ItemS", "Item service type", UDFFieldType.Alpha, false, 100, "", "", "");
            FieldDetails(TableType.CustomTable, "CCBI", "St", "Status", UDFFieldType.Alpha, false, 100, "", "", "");
            FieldDetails(TableType.CustomTable, "CCBI", "sale", "sales employee", UDFFieldType.Alpha, false, 100, "", "", "");
            FieldDetails(TableType.CustomTable, "CCBI", "Own", "Owner Code", UDFFieldType.Alpha, false, 100, "", "", "");
            ...
            FieldDetails(TableType.CustomTable, "BOUR1", "cc", "cardCode", UDFFieldType.Alpha, false, 30, "", "", "");
            FieldDetails(TableType.CustomTable, "BOUR1", "Itemc", "ItemCode", UDFFieldType.Alpha, false, 30, "", "", "");
            FieldDetails(TableType.CustomTable, "BOUR1", "Dscription", "Dscription", UDFFieldType.Alpha, false, 100, "", "", "");
            FieldDetails(TableType.CustomTable, "BOUR1", "quantity", "Quantity", UDFFieldType.Alpha, false, 30, "", "", "");
            FieldDetails(TableType.CustomTable, "BOUR1", "wsh", "warehouse", UDFFieldType.Alpha, false, 30, "", "", "");
            FieldDetails(TableType.CustomTable, "BOUR1", "Docda", "docdate", UDFFieldType.Date, false, 30, "", "", "");
            FieldDetails(TableType.CustomTable, "BOUR1", "PostD", "PostDate", UDFFieldType.Date, false, 30, "", "", "");
            FieldDetails(TableType.CustomTable, "BOUR1", "dueD", "Duedate", UDFFieldType.Date, false, 30, "", "", "");
        ...
        private void CreateObjects()
        {
            ...
            CreateUserObjectDocuments("BOUR", "BOUR", "BOUR", "BOUR1", "", "", "", false);
            CreateUserObjectDocuments("DCBA", "DCBA", "DCBA", "DCBA1", "", "", "", false);
        }
