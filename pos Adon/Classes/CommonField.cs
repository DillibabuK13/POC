namespace General.Classes
{
    public static class CommonFields
    {
        ...
        public const string MnfSerial = "MnfSerial";
        public const string ManBtchNum = "ManBtchNum";
        public const string Father = "Father";

      //  public const string ItemCode = U_itemcode;
        public const string Quantity = "Quantity";
        public const string Qauntity = "Qauntity";
        ...
        public const string PaymentTerms = "GroupNum";
        ...
        public const string PlannedQty = "PlannedQty";
        public const string UgpEntry = "UgpEntry";
        public const string NumPerMsr = "NumPerMsr";
        ...
        public const string UomCode = "UomCode";
        public const string UomEntry = "UomEntry";
    }
}
